...
openxlsx:::addWorksheet(wb, "Weekly")
	...
	### SVR
	  ...
	  #grid space to search for the best hyper parameters
	  tuneGrid <- expand.grid(C = c(0.25, .5, 1),sigma = 0.1)
	  svm_weekly_ischemic_count <- train(X_train, y_train,  trControl = svr_trcontrol
									 ,tuneGrid = tuneGrid,method = "svmRadial"
									 ,preProcess = c("center"), verbosity = 0)
	...
	### XGB 
	  ...
	  #final xgb model with chosen hyper parameter
	  print("fitting xgboost based on chosen hyperparameter")
	  xgb_weekly_bleeding_count = train(X_train, y_train,  trControl = xgb_trcontrol
									 ,tuneGrid = final_grid,method = "xgbTree", verbosity = 0)
	  #predict
...
openxlsx:::addWorksheet(wb, "Monthly")
	...
	### RF
	  ...
	  #final xgb model with chosen hyper parameter
	  print("fitting forest based on chosen hyperparameter")
	  forest_monthly_total_count = train(X_train, y_train,  trControl = repeat_cv,tuneGrid = final_grid,method = "rf", verbosity = 0)
	  #predict
	...
	### XGB
	  ...
	  #final xgb model with chosen hyper parameter
	  print("fitting xgboost based on chosen hyperparameter")
	  xgb_monthly_total_count = train(X_train, y_train,  trControl = xgb_trcontrol
									,tuneGrid = final_grid,method = "xgbTree", verbosity = 0)
	  #predict
	...
	### SVR
	  ...
	  #grid space to search for the best hyper parameters
	  tuneGrid <- expand.grid(C = c(0.25, .5, 1),sigma = 0.1)
	  svm_monthly_total_count <- train(X_train, y_train,  trControl = svr_trcontrol
								   ,tuneGrid = tuneGrid,method = "svmRadial"
								   ,preProcess = c("center"), verbosity = 0)
	...
	### SVR
	  ...
	  #grid space to search for the best hyper parameters
	  tuneGrid <- expand.grid(C = c(0.25, .5, 1),sigma = 0.1)
	  svm_monthly_ischemic_count <- train(X_train, y_train,  trControl = svr_trcontrol
									 ,tuneGrid = tuneGrid,method = "svmRadial"
									 ,preProcess = c("center"), verbosity = 0)
	...
	### SVR
	  ...
	  #grid space to search for the best hyper parameters
	  tuneGrid <- expand.grid(C = c(0.25, .5, 1),sigma = 0.1)
	  svm_monthly_bleeding_count <- train(X_train, y_train,  trControl = svr_trcontrol
									  ,tuneGrid = tuneGrid,method = "svmRadial"
									  ,preProcess = c("center"), verbosity = 0)
