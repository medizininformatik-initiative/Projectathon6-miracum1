...
knit_error( cohort_dq_report$long_format$con_contradictions$results[[1]]$SummaryPlot, 'Could print Contradictions SummaryPlot for Cohort. Error: ')
...
knit_error( cohort_dq_report$long_format$con_contradictions$results[[1]]$SummaryTable, 'Could print Contradictions SummaryTable for Cohort. Error: ')
...
knit_error( cohort_metadata$VALUE_LABELS[cohort_metadata$LABEL == "gender"], 'Could print Genders for Cohort. Error: ')
knit_error( cohort_dq_report$long_format$con_limit_deviations$results[[1]]$SummaryPlotList$gender, 'Could print SummaryPlotList$gender for Cohort. Error: ')
...
knit_error( cohort_dq_report$long_format$con_limit_deviations$results[[1]]$SummaryPlotList$age, 'Could print SummaryPlotList$age for Cohort. Error: ')
...
knit_error( cohort_metadata$VALUE_LABELS[cohort_metadata$LABEL == "icd"], 'Could print ICD10 Codes for Cohort. Error: ')
knit_error( cohort_dq_report$long_format$con_limit_deviations$results[[1]]$SummaryPlotList$icd, 'Could print SummaryPlotList$icd for Cohort. Error: ')
...
knit_error( cohort_metadata$VALUE_LABELS[cohort_metadata$LABEL == "patient_type_fhir_class"], 'Could print FHIR Class for Cohort. Error: ')
knit_error( cohort_dq_report$long_format$con_limit_deviations$results[[1]]$SummaryPlotLis$patient_type_fhir_class, 'Could print SummaryPlotLis$patient_type_fhir_class for Cohort. Error: ')
...
knit_error( observations_dq_report$long_format$con_limit_deviations$results[[1]]$SummaryPlotList$value, 'Could print SummaryPlotList$value for Observations. Error: ')
...
knit_error( observations_metadata$VALUE_LABELS[observations_metadata$LABEL == "loinc_code"], 'Could print LOINC Codes for Observations. Error: ')
knit_error( observations_dq_report$long_format$con_limit_deviations$results[[1]]$SummaryPlotList$loinc_code, 'Could print SummaryPlotList$loinc_code for Observations. Error: ')
...
knit_error( observations_metadata$VALUE_LABELS[observations_metadata$LABEL == "unit"], 'Could print Units for Observations. Error: ')
knit_error( observations_dq_report$long_format$con_limit_deviations$results[[1]]$SummaryPlotList$unit, 'Could print SummaryPlotList$unit for Observations. Error: ')
...
knit_error( cohort_dq_report$long_format$com_item_missingness$results[[1]]$SummaryTable, 'Could print SummaryTable for Cohort. Error: ') 
...
knit_error( observations_dq_report$long_format$com_item_missingness$results[[1]]$SummaryTable, 'Could print SummaryTable for Observations. Error: ') 
...
#Plot
knit_error( cohort_dq_report$long_format$com_item_missingness$results[[1]]$SummaryPlot, 'Could print SummaryPlot for Cohort. Error: ') 
knit_error( observations_dq_report$long_format$com_item_missingness$results[[1]]$SummaryPlot, 'Could print SummaryPlot for Observations. Error: ') 
...
knit_error( cohort_dq_report$app_mat$ApplicabilityPlot, 'Could print ApplicabilityPlot for Cohort. Error: ') 
knit_error( observations_dq_report$app_mat$ApplicabilityPlot, 'Could print ApplicabilityPlot for Observations. Error: ')
